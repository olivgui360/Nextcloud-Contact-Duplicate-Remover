...
<d:propfind xmlns:d="DAV:" xmlns:card="urn:ietf:params:xml:ns:carddav">
  <d:prop>
    ...
    def find_duplicates(self, contacts: List[Dict], similarity_threshold: int = 85, strict: bool = False) -> Dict[str, List[Dict]]:
        """
        ...
        for i, contact1 in enumerate(contacts):
            ...
            for j, contact2 in enumerate(contacts[i+1:], start=i+1):
                ...
                if self._are_duplicates(contact1, contact2, similarity_threshold, strict):
    ...
    def _are_duplicates(self, contact1: Dict, contact2: Dict, threshold: int, strict: bool = False) -> bool:
        ...
        # En mode strict, on ignore toute logique fuzzy sur les noms
        if strict:
            return False
    ...
    def remove_duplicates(self, dry_run: bool = True, similarity_threshold: int = 85, strict: bool = False) -> Tuple[int, int]:
        """
        ...
        duplicate_groups = self.find_duplicates(contacts, similarity_threshold, strict)
...
Pour les installer: pip install -r requirements.txt
    ...
    api_parser.add_argument('--strict', action='store_true',
                           help='Désactive la détection fuzzy sur les noms (email/téléphone exacts uniquement)')
    ...
    try:
        if args.mode == 'api':
            ...
            if args.type == 'contacts':
                ...
                duplicates_found, deleted_count = manager.remove_duplicates(
